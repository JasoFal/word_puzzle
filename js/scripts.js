...
// Business Logic
function randomSentenceGenerator(rngText)  {
...
function puzzleGenerator(rngText) {
  const textArray = rngText.split(" ");
  let puzzleArray = [];
...
//need help function not working call Justin on Monday.
// UI Logic